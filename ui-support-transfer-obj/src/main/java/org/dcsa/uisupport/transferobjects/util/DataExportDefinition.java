...
public class DataExportDefinition<T> {
  ...
  public int getColumnIndexOf(String column) {
    ...
    return columnDefinition.columnIndex();
  }
  ...
  public static <T> DataExportDefinition<T> of(LinkedHashMap<String, Function<T, Object>> mapperFunctions, BiConsumer<DataExportDefinition<T>, XSSFPivotTable> pivotTableGenerator) {
    ...
    for (Map.Entry<String, Function<T, Object>> entry : mapperFunctions.entrySet()) {
      ...
      ColumnDefinition<T> columnDefinition = new ColumnDefinition<>(columnIndex++, entry.getValue());
  ...
  private record ColumnDefinition<T>(int columnIndex, Function<T, Object> valueExtractor) {}
  ...
  public static class Builder<T> {
    ...
    public Builder<T> column(String columnName, Function<T, Object> valueExtractor) {
      ColumnDefinition<T> columnDefinition = new ColumnDefinition<>(columnDefinitions.size(), valueExtractor);
    ...
    public <I1, I2, I3, I4> Builder<T> column(String columnName, Function<T, I1> mappingA, Function<I1, I2> mappingB, Function<I2, I3> mappingC, Function<I3, I4> mappingD, Function<I4, Object> valueExtractor) {
      return column(columnName, combine(combine(mappingA, mappingB, mappingC, mappingD), valueExtractor));
    }
