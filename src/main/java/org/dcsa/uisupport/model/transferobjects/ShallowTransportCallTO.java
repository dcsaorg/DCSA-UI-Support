...
public class ShallowTransportCallTO extends AbstractTransportCall {
  ...
  @Transient private String carrierServiceCode;

  @Transient private String carrierVoyageNumber;
  ...
  @Transient private FacilityCodeListProvider facilityCodeListProvider;

  @ForeignKey(
      fromFieldName = "facilityID",
      foreignFieldName = "facilityID",
  ...
  @ForeignKey(
      fromFieldName = "locationID",
      foreignFieldName = "id",
      joinType = Join.JoinType.LEFT_OUTER_JOIN)
  @Transient
  private LocationTO location;

  @Transient private String modeOfTransport;
