...
public class TransportCallWithTimestampsIT {
  ...
  public void testGetTransportCallsWithVesselIMONumberQueryParameter() {
    given()
      .contentType(ContentType.JSON)
      .queryParam("vessel.vesselIMONumber", "1234567")
      .get("/v1/unofficial/transport-calls")
      .then()
      .assertThat()
  ...
  public void testGetTransportCallsWithUNLocationCodeQueryParameter() {
    given()
      .contentType(ContentType.JSON)
      .queryParam("facility.UNLocationCode", "USMIA")
      .get("/v1/unofficial/transport-calls")
      .then()
      .assertThat()
      .statusCode(HttpStatus.SC_OK)
  ...
  @Test
  public void testGetTrandsportCallsWithUNLocationCodeQueryParameter() {
    given()
      .contentType(ContentType.JSON)
      .queryParam("facility.facilitySMDGCode", "USMIA")
      .get("/v1/unofficial/transport-calls")
      .then()
      .assertThat()
      .statusCode(HttpStatus.SC_OK)
  ...
  public void testPostTransportCalls() {
    ...
    TransportCallWithTimestampsTO saved =
        given()
            .contentType("application/json")
    ...
    List<TransportCallWithTimestampsTO> calls =
        given()
            .contentType("application/json")
            .get("/v1/unofficial/transport-calls")
            .then()
    ...
    assertTrue(
        calls.stream().anyMatch(tc -> tc.getTransportCallID().equals(saved.getTransportCallID())));
  }
}
